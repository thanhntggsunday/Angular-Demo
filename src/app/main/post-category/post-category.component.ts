...
export class PostCategoryComponent implements OnInit {
  ...
  loadData() {
    var url = SystemConstants.API_POST_CATEGORY_SERVICE_GET_ALL;
  ...
  public showEdit(id: any) {
    let url = '/main/post-category' + '/add-edit/' + id + '/edit';
    this._utilityService.navigate(url);
  }

  public showAdd() {
    let url = '/main/post-category' + '/add-edit/0'  + '/add';
    this._utilityService.navigate(url);
  }
  ...
  deleteItemConfirm(id: any) {
    this.bodyData = { ID: id };
    this._dataService.post(SystemConstants.API_POST_CATEGORY_SERVICE_DELETE, this.bodyData)
      .subscribe((response: any) => {
