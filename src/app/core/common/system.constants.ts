export class SystemConstants {
    ...
    public static API_POST_CATEGORY_SERVICE_GET_ALL = "/api/PostCategoryService/GetAll";
    public static API_POST_CATEGORY_SERVICE_CREATE = "/api/PostCategoryService/Create";
    public static API_POST_CATEGORY_SERVICE_UPDATE = "/api/PostCategoryService/Update";
    public static API_POST_CATEGORY_SERVICE_DELETE = "/api/PostCategoryService/Delete";
    public static API_POST_CATEGORY_SERVICE_GET_BY_ID = "/api/PostCategoryService/GetById";

    public static API_POST_SERVICE_GET_ALL = "/api/PostService/GetAllPaging";
    public static API_POST_SERVICE_CREATE = "/api/PostService/Create";
    public static API_POST_SERVICE_UPDATE = "/api/PostService/Update";
    public static API_POST_SERVICE_DELETE = "/api/PostService/Delete";
    public static API_POST_SERVICE_GET_BY_ID = "/api/PostService/GetById";

    public static API_ORDER_SERVICE_GET_ALL_PAGING = "/api/OrderService/GetAllPaging";   
    public static API_ORDER_SERVICE_UPDATE = "/api/OrderService/Update";
    public static API_ORDER_SERVICE_GET_BY_ID = "/api/OrderService/GetById";
    public static API_ORDER_SERVICE_GET_ORDER_DETAILS_BY_ORDER_ID = "/api/OrderService/GetAllOrderDetailsByOrderId";
